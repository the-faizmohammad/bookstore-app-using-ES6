...
**Awesome books: with ES6
!** 
Welcome to the  repository for our Awesome Book store!
This repository contains the code and assets for our boostore website. The website serves as a hub for creating bookstore list with add/remove function using javascript-ES6 , HTML & CSS.
...
- **Used luxon library**
- **Add/remove book**
- **Refactor the JS function in difeerent module**
